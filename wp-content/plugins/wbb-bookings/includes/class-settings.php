...
class WBB_Settings {
	...
	public static function get_defaults() {
		return array(
			...
			'template_admin_notification' => "New booking request {booking_ref}. Customer: {customer_name}. Email: {customer_email}. Phone: {customer_phone}. Date: {date}. Time: {time}. Duration: {duration} hours. Group size: {group_size}. Boats requested: {boats}. Estimated price: {estimated_price}. Notes: {notes}. Log in to confirm or cancel this booking.",
