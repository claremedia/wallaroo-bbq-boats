...
add_action( 'acf/init', function () {
    ...
    acf_add_local_field_group( [
        ...
        'fields' => [
            ...
            [
                'key'           => 'field_gv_cta_heading',
                'label'         => 'Bottom CTA — Heading',
                'name'          => 'gv_cta_heading',
                'type'          => 'text',
                'default_value' => 'Give the Gift of a Day on the Water',
            ],
            [
                'key'           => 'field_gv_cta_subtext',
                'label'         => 'Bottom CTA — Subtext',
                'name'          => 'gv_cta_subtext',
                'type'          => 'text',
                'default_value' => 'Sunshine, good food, and time out on the water.',
            ],
        ],
